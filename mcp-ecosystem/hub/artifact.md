...
---
22-page multi-section site (understand/sell/build/govern/plan) sharing
`styles.css`/`nav.js`; entry point `index.html` (already correctly named).
Cross-links into the RHCL hub (`features/mcp-gateway/enablement/rhcl-hub/`)
once both are published. Published via publish/manifest.yaml
(dest `mcp-ecosystem/hub/`).
