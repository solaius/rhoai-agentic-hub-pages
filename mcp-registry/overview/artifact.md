...
rewritten from the old repo's relative `prototype/index-v0.2-mockup.html`
path to `../ui-prototype/` (this hub's registry-ui-prototype artifact).
Published via publish/manifest.yaml (dest mcp-registry/overview/).
